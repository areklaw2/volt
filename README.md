...
Volt is a full-stack real-time chat application with a React frontend and a Rust backend. It supports direct and group conversations over WebSockets, image uploads, and a clean, themeable UI. No auth layer — it's a toy project, ids are passed directly.
